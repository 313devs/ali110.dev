    ...
    <Popover.Root>
      ...
      <Popover.Portal>
        <Popover.Content
          ...
          sideOffset={5}
        >
          <div className="w-38 h-fit rounded-lg mb-2 overflow-hidden flex justify-center items-center 2xl:w-64 2xl:h-64">
            <Image
            ...
            />
            <h1 className="text-center text-xl font-popL absolute">Resume.pdf</h1>
          </div>
